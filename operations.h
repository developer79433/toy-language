...
void op_nequal(toy_interp *interp, toy_val *result, toy_expr *arg1, toy_expr *arg2);
...
void op_lt(toy_interp *interp, toy_val *result, toy_expr *arg1, toy_expr *arg2);
void op_lte(toy_interp *interp, toy_val *result, toy_expr *arg1, toy_expr *arg2);
void op_minus(toy_interp *interp, toy_val *result, toy_expr *arg1, toy_expr *arg2);
void op_mul(toy_interp *interp, toy_val *result, toy_expr *arg1, toy_expr *arg2);
void op_not(toy_interp *interp, toy_val *result, toy_expr *arg);
void op_or(toy_interp *interp, toy_val *result, toy_expr *arg1, toy_expr *arg2);
void op_plus(toy_interp *interp, toy_val *result, toy_expr *arg1, toy_expr *arg2);
void op_modulus(toy_interp *interp, toy_val *result, toy_expr *arg1, toy_expr *arg2);
