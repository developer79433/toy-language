...
typedef item_callback_result (*bucket_visit_func)(map_visitor *visitor, generic_map_entry_list *bucket);
...
typedef item_callback_result (*const_bucket_visit_func)(const_map_visitor *visitor, const generic_map_entry_list *bucket);
