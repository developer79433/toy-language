...
void test_maps(void)
{
    ...
    // Test first insert
    toy_expr val1 = { .type = EXPR_NUM, .val.num = 42 };
    ...
    // Test second insert
    toy_expr val2 = { .type = EXPR_STR, .val.str = "second value" };
