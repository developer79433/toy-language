...
{
    toy_buf_list *new_list = (toy_buf_list *) list_alloc_size(buf_size);
...
{
    toy_buf_list *new_list = (toy_buf_list *) list_alloc_size(buf1_size + buf2_size);
...
{
    return (toy_buf_list *) list_concat((generic_list *) list, (generic_list *) new_list);
}
...
{
    return (toy_buf_list *) list_remove_first((generic_list *) list, (generic_list **) removed);
}

toy_buf_list *buf_list_remove_last(toy_buf_list *list, toy_buf_list **removed)
{
    return (toy_buf_list *) list_remove_last((generic_list *) list, (generic_list **) removed);
}
...
{
    toy_buf_list *found = (toy_buf_list *) list_index((generic_list *) list, index);
    if (found) {
...
{
    const toy_buf_list *found = (const toy_buf_list *) list_index_const((const generic_list *) list, index);
    if (found) {
