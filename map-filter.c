...
generic_map_entry *map_filter_last_match(const map_filter *filter)
{
...
void map_filter_init(map_filter *filter, generic_map_filter_func filter_func, void *filter_cookie, toy_bool inverted)
{
...
const generic_map_entry *const_map_filter_last_match(const const_map_filter *filter)
{
    return filter->last_match;
}
...
void const_map_filter_init(const_map_filter *filter, generic_map_filter_func filter_func, void *filter_cookie, toy_bool inverted)
{
